        ...
        return(
                <div className="gridbg">
                        ...
                        <div className="boxarea">
                            <div class="filtertable">
                                ...
                                <div onClick={()=>{setIsDivYes(isDivYes==="Y"?"N":isDivYes==="N"?"all":"Y")}} style={{display:"flex",margin:"5px 0px 0px 5px",borderRadius:"25px",backgroundColor:"#77777717",width:"fit-content",padding:"5px",fontSize:"14px",cursor:"pointer",userSelect:"none"}}>
                                    <div style={{color:isDivYes==="Y"?"black":"#bbbbbb",margin:"0px 10px 0px 10px"}}>Y</div>/
                                    <div style={{color:isDivYes==="N"?"black":"#bbbbbb",margin:"0px 10px 0px 10px"}}>N</div>/
                                    <div style={{color:isDivYes==="all"?"black":"#bbbbbb",margin:"0px 10px 0px 10px"}}>All</div>
                                </div>
                            </div>
                            {
                    ...
                    <div className="box box5">
                        ...
                        <div className="boxarea"><ScatterChartExample/></div>
                    </div>
